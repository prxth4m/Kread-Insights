...
export interface DailyMetrics {
  ...
  kptMinutes: number;
  forAccuracy: number;
  nonRefundedComplaints: number;
  complaintsPoorPackaging: number;
  complaintsPoorQuality: number;
  complaintsWrongOrder: number;
  complaintsMissingItems: number;
  selfLogsOtherOrs: number;
  // Customer Funnel
  impressions: number;
  impressionsToMenu: number;
  menuToCart: number;
  cartToOrder: number;
  menuOpens: number;
  cartBuilds: number;
  ...
  repeatUserOrders: number;
  lapsedUserOrders: number;
  lunchOrders: number;
  dinnerOrders: number;
  snacksOrders: number;

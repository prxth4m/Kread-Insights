      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <Button asChild variant="outline" size="sm">
            <Link to={`/analysis?restaurantId=${id}`}>
        ...
        <TabsContent value="funnel" className="space-y-4 mt-4">
          <div className="grid gap-4 md:grid-cols-4">
            ...
            <MetricCard
              ...
              current={Number(latestMetrics?.impressionsToMenu) || 0}
              previous={Number(previousMetrics?.impressionsToMenu)}
              format="percent"
              trend={getTrend(Number(latestMetrics?.impressionsToMenu) || 0, Number(previousMetrics?.impressionsToMenu) || 0)}
            />
            <MetricCard
              label="Menu to Cart"

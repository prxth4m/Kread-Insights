...
export function AdminRestaurantsPage() {
  ...
  const fetchRestaurants = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE}/restaurants/?include_archived=false`, {
  ...
  const handleSaveRestaurant = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.error(error.detail || 'Failed to save restaurant');
      }
    } catch (error) {
  ...
  const handleArchiveRestaurant = async () => {
    ...
    try {
      const response = await fetch(`${API_BASE}/restaurants/${restaurantToArchive.id}/archive`, {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${token}`,
          'Content-Type': 'application/json',
      ...
      if (response.ok) {
        ...
        const error = await response.json();
        toast.error(error.detail || 'Failed to archive restaurant');
      }
    } catch (error) {
